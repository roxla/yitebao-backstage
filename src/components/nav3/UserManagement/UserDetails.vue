<template>
  <div id="user-details">
    <div class="details-page">
      ...
      <el-tabs class="user-details-tabs" type="border-card">
        <el-tab-pane>
          <span slot="label">洗护订单(0)</span>
        </el-tab-pane>
        <el-tab-pane>
          <span slot="label">商场订单(0)</span>
        </el-tab-pane>
        <el-tab-pane>
          <span slot="label">积分记录</span>
        </el-tab-pane>
        <el-tab-pane>
          <span slot="label">名下会员卡(0)</span>
        </el-tab-pane>
      </el-tabs>
    </div>
  </div>
